...
export async function POST(request: NextRequest) {
  try {
    ...
    let externalCompany: string | undefined = 'WhatsApp Bot'
    let externalContact: string | undefined = ticketData.whatsapp_user_name || ticketData.whatsapp_user_id || undefined
    ...
    const createTicketPayload = {
      ...
      requester_id: userId,
      origin: ticketOrigin,
      external_company: externalCompany ?? undefined,
      external_contact: externalContact ?? undefined,
      area: 'DTI' as const,
    }
