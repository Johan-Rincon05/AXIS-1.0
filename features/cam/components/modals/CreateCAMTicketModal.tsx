...
export function CreateCAMTicketModal({ isOpen, onClose, onSubmit, currentUser, users }: CreateCAMTicketModalProps) {
      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto p-0 gap-0">
        <div className="sticky top-0 z-10 bg-gradient-to-r from-violet-600 to-purple-700 px-6 py-4 rounded-t-xl">
          <DialogHeader>
            ...
            <p className="text-violet-200 text-xs mt-0.5">Comunicaciones Audiovisuales y Marketing</p>
          </DialogHeader>
        </div>
        ...
        <div className="px-6 py-5 space-y-5">
          ...
          <div className="flex items-start gap-3 rounded-lg border border-violet-200 dark:border-violet-800 bg-violet-50 dark:bg-violet-950/40 px-4 py-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-violet-600 dark:text-violet-400 mt-0.5">
                ...
                El tiempo inicia cuando la solicitud esté completa.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-1.5">
            ...
            />
            {errors.objetivo_solicitud && <p className="text-xs text-red-500">{errors.objetivo_solicitud}</p>}
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-1.5">
              ...
              />
              {errors.publico_objetivo && <p className="text-xs text-red-500">{errors.publico_objetivo}</p>}
            </div>
            <div className="space-y-1.5">
              <Label className="text-xs font-semibold text-zinc-600 dark:text-zinc-400 uppercase tracking-wider">
                Mensaje clave *
              ...
              />
              {errors.mensaje_clave && <p className="text-xs text-red-500">{errors.mensaje_clave}</p>}
            </div>
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <Textarea
              ...
              placeholder="Ej: Necesito un flyer vertical para Instagram (1080x1920px) con los logos institucionales…"
          ...
          <div className="space-y-1.5">
            <Label className="text-xs font-semibold text-zinc-600 dark:text-zinc-400 uppercase tracking-wider flex items-center gap-2">
              ...
              <Badge variant="outline" className="text-[10px] border-violet-300 text-violet-600 dark:text-violet-400 font-normal">
          ...
          <div className="rounded-lg bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-800 px-4 py-3 text-xs text-amber-700 dark:text-amber-400 space-y-1">
            ...
            <ul className="list-disc list-inside space-y-0.5 text-amber-600 dark:text-amber-500">
              ...
              <li>Solicitudes urgentes están sujetas a disponibilidad del equipo.</li>
