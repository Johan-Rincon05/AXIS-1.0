  ...
  const defaultUsers = [
    {
      ...
      email: "gerente@emprendetucarrera.com.co",
    ...
    {
      id: "user-2",
      email: "tecnico@emprendetucarrera.com.co",
      name: "Técnico DTI",
      phone: "+573007654321",
      role: "Empleado",
      area: "DTI",
    ...
    {
      id: "user-3",
      email: "coordinador@emprendetucarrera.com.co",
      name: "Coordinador CAM",
      phone: "+573009876543",
      role: "Coordinador",
      area: "CAM",
      is_active: true,
    ...
    {
      id: "user-4",
      email: "asistencia@emprendetucarrera.com.co",
      name: "Asistencia CAM",
      phone: "+573005555555",
      role: "Asistencia",
      area: "CAM",
